  ...
  const fetchSchedule = useCallback(() => {
    ...
    api
      ...
      .then((res) => {
        ...
        const nextTrainIndex = res.trains.findIndex((t) => t.departureTime >= currentTimeStr);
        ...
        if (nextTrainIndex === -1) {
          ...
          recommendedTrain =
            displayTrains.find((t) => t.departureTime >= currentTimeStr) || displayTrains[0];
        }
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span className="label-dim" style={{ marginBottom: 0 }}>
          Upcoming Trains
        </span>
        <button
      ...
      {trains.map((train) => {
        ...
        const isNext =
          ...
          !trains.some(
            (t) => t.departureTime >= currentTimeStr && t.departureTime < train.departureTime
          );
        ...
        return (
          <div
            ...
            style={{
              ...
              background: isSelected ? 'rgba(56, 189, 248, 0.1)' : 'var(--color-card-bg)',
            }}
          >
            <div>
